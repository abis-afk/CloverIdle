...
การเสริมพลังอุปกรณ์ใน **Clover Idle Story** ประกอบด้วย 4 ขั้นตอนหลัก ซึ่งช่วยยกระดับพลังโจมตีและค่าสเตตัสของตัวละครอย่างก้าวกระโดด
...
## ⭐ 2. ระบบ Star Force (ดาวตีบวก)
* เมื่อช่อง Scroll เต็มแล้ว สามารถใช้เงิน Meso ในการเสริมพลังดาวได้สูงสุดถึง **25 ดาว (25 Stars)**
* ทุกๆ ดาวที่เพิ่มขึ้นจะมอบ All Stat และ Weapon/Magic ATT เพิ่มขึ้น โดยเฉพาะตั้งแต่ระดับ 16 ดาวขึ้นไป พลังโจมตีจะเพิ่มขึ้นแบบก้าวกระโดด

---

## 🔮 3. ระบบ Potential & Cubes (ออพชั่นศักยภาพ)
* ปลดล็อคความสามารถแฝงของอุปกรณ์ แบ่งออกเป็น 4 ระดับ:
  * **Rare** (ฟ้า)
  * **Epic** (ม่วง)
  * **Unique** (ทอง)
  * **Legendary** (เขียว)
