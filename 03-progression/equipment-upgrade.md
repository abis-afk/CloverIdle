...
| **15%** | **15%** | **+9 ATT / M.ATT**, +4 Main Stat | *(ชุดเกราะไม่มี Scroll 15%)* | **มาตรฐานสำหรับอาวุธ End-Game** พลังโจมตีสูงสุด |
...
| :--- | :--- | :---: | :--- |
| **Flat Weapon / Magic ATT** | **อาวุธ (Weapon)** | **+15 ถึง +150+** *(ตาม Base ATT)* | **สำคัญที่สุดของอาวุธ!** ดันดาเมจได้มหาศาล |
| **Flat Weapon / Magic ATT** | เกราะ & เครื่องประดับ | **+1 ถึง +7** | สเตตัสโบนัสเล็กน้อยบนชุดเกราะ |
| **Boss Monster Damage %** | **อาวุธเท่านั้น!** | **+4% ถึง +14%** *(Tier 3-7)* | ช่วยเร่งดาเมจเมื่อต่อสู้กับบอส |
| **Damage %** | **อาวุธเท่านั้น!** | **+1% ถึง +7%** *(Tier 1-7)* | เพิ่มพลังโจมตีทั่วไป |
| **All Stat %** | **ทุกชิ้นส่วน** (เน้นเกราะ/ประดับ) | **+1% ถึง +7%** *(Tier 1-7)* | **ออพชั่น % หนึ่งเดียวของไฟบนชุดเกราะ!** |
| **Single Stat (STR, DEX, INT, LUK)** | **ทุกชิ้นส่วน** | **+10 ถึง +75+** *(ตามเลเวลไอเทม)* | สเตตัสเดี่ยวบวกตรง |
...
สำหรับชุดเกราะและเครื่องประดับ ผู้เล่นนิยมคิดคะแนนความคุ้มค่าเป็น **Flame Score**:
$$\text{Flame Score} = \text{Main Stat รวม (เดี่ยว + คู่)} + (\text{All Stat \%} \times 10) + (\text{Flat ATT} \times 4)$$
