...
| หมวดหมู่                                                                       | รายละเอียด                                                                             |
| ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- |
| [🔰 ข้อมูลเบื้องต้น](undefined/introduction.md)                                | ข้อมูลเซิร์ฟเวอร์, กฎกติกา และการดาวน์โหลดติดตั้ง                                      |
| [⌨️ คำสั่งผู้เล่น](undefined/player-commands.md)                               | รวมคำสั่งพิมพ์ในเกมทั้งหมด เช่น `@bot`, `@check`, `@bossinfo`                          |
...
> 💡 **Tip สำหรับผู้เล่นใหม่:** แนะนำให้อ่าน [คำสั่งผู้เล่น](undefined/player-commands.md) และ [ระบบบอท @bot](and-systems/auto-play.md) เป็นอันดับแรก เพื่อความสะดวกรวดเร็วในการเก็บเลเวลและฟาร์มไอเทม!
