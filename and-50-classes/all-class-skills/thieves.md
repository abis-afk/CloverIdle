...
* **🎯 แนะนำตั้งปุ่มบอท 1-4:**
  *   `[1]`
      ...
      <img src="../../.gitbook/assets/4121017.png" alt="Showdown" height="20" width="20">

      **Showdown** (ปามีดกวาดมอน + มอบโบนัส EXP/Drop)
  *   `[2]`

      <img src="../../.gitbook/assets/400041002.png" alt="Fuma Shuriken" height="20" width="20">

      **Fuma Shuriken** (กงจักรยักษ์หมุนฟันต่อเนื่อง)
  *   `[3]`

      <img src="../../.gitbook/assets/400041038.png" alt="Dark Lord&#x27;s Omen" height="20" width="20">

      **Dark Lord's Omen** (ป้ายหลุมศพเรียกดาวกระจายถล่มพื้น)
  *   `[4]`

      <img src="../../.gitbook/assets/400041001.png" alt="Throwing Star Barrage" height="20" width="20">
...
* **🎯 แนะนำตั้งปุ่มบอท 1-4:**
  *   `[1]`
      ...
      <img src="../../.gitbook/assets/4221007.png" alt="Cruel Stab" height="20" width="20">

      **Cruel Stab** (แทงมีดเงาวงกว้าง)
  *   `[2]`

      <img src="../../.gitbook/assets/4210014.png" alt="Meso Explosion" height="20" width="20">

      **Meso Explosion** (ระเบิดเหรียญ Meso บนพื้นกวาดมอนสเตอร์รอบตัว)
  *   `[3]`

      <img src="../../.gitbook/assets/400041039.png" alt="Sonic Blow" height="20" width="20">

      **Sonic Blow** (สับมีดความเร็วเหนือเสียง)
  *   `[4]`

      <img src="../../.gitbook/assets/400041069.png" alt="Slash Shadow Formation" height="20" width="20">
...
* **🎯 แนะนำตั้งปุ่มบอท 1-4:**
  *   `[1]`
      ...
      <img src="../../.gitbook/assets/4341004.png" alt="Blade Furious" height="20" width="20">

      **Blade Furious** (ควงมีดคู่หมุนฟันรอบทิศ 360 องศา)
  *   `[2]`

      <img src="../../.gitbook/assets/400040006.png" alt="Karma Fury" height="20" width="20">

      **Karma Fury** (ยมทูตเงาฟาดฟันรอบตัวคูลดาวน์สั้น)
  *   `[3]`

      <img src="../../.gitbook/assets/400041021.png" alt="Blades of Destiny" height="20" width="20">

      **Blades of Destiny** (มีดยักษ์ตกลงมาจากฟ้า)
  *   `[4]`

      <img src="../../.gitbook/assets/400040006.png" alt="Blade Tempest" height="20" width="20">
...
* **🎯 แนะนำตั้งปุ่มบอท 1-4:**
  *   `[1]`
      ...
      <img src="../../.gitbook/assets/14111022.png" alt="Shadow Spark" height="20" width="20">

      **Shadow Spark** (ปาดาวกระจายความมืดระเบิดชิ่ง)
  *   `[2]`

      <img src="../../.gitbook/assets/400041037.png" alt="Shadow Bite" height="20" width="20">

      **Shadow Bite** (เงากัดกินมอนสเตอร์ทั่วทั้งจอ + บัฟ Final Damage)
  *   `[3]`

      <img src="../../.gitbook/assets/400040008.png" alt="Shadow Spear" height="20" width="20">

      **Shadow Spear** (หอกเงาพุ่งขึ้นมาจากพื้นทุกการโจมตี)
  *   `[4]`

      <img src="../../.gitbook/assets/400041059.png" alt="Rapid Throw" height="20" width="20">
...
* **🎯 แนะนำตั้งปุ่มบอท 1-4:**
  *   `[1]`
      ...
      <img src="../../.gitbook/assets/36121011.png" alt="Mecha Purge: Bombard" height="20" width="20">

      **Mecha Purge: Bombard** (มิสไซล์ยิงกวาดมอนสเตอร์)
  *   `[2]`

      <img src="../../.gitbook/assets/36121000.png" alt="Hyperspeed Slicer" height="20" width="20">

      **Hyperspeed Slicer** (พุ่งฟันเลเซอร์ต่อเนื่อง)
  *   `[3]`

      <img src="../../.gitbook/assets/400041057.png" alt="Photon Ray" height="20" width="20">

      **Photon Ray** (ดาวเทียมล็อคเป้ายิงเลเซอร์อัตโนมัติ)
  *   `[4]`

      <img src="../../.gitbook/assets/400041007.png" alt="Mega Smash" height="20" width="20">
...
* **🎯 แนะนำตั้งปุ่มบอท 1-4:**
  *   `[1]`
      ...
      <img src="../../.gitbook/assets/24121000.png" alt="Mille Aiguilles" height="20" width="20">

      **Mille Aiguilles** (แทงการ์ดเร็วดั่งพายุ)
  *   `[2]`

      <img src="../../.gitbook/assets/400041022.png" alt="Ace in the Hole" height="20" width="20">

      **Ace in the Hole** (ไพ่ใบตายบินเด้งชิ่งทั่วทั้งแมพ)
  *   `[3]`

      <img src="../../.gitbook/assets/24121005.png" alt="Tempest" height="20" width="20">

      **Tempest** (พายุไพ่หมุนรอบตัวกวาดมอนสเตอร์)
  *   `[4]`

      <img src="../../.gitbook/assets/400041055.png" alt="Rift Break" height="20" width="20">
...
* **🎯 แนะนำตั้งปุ่มบอท 1-4:**
  *   `[1]`
      ...
      <img src="../../.gitbook/assets/60021278.png" alt="Chain Arts: Thrash" height="20" width="20">

      **Chain Arts: Thrash** (เหวี่ยงโซ่กวาดศัตรู)
  *   `[2]`

      <img src="../../.gitbook/assets/400041041.png" alt="Chain Arts: Maelstrom" height="20" width="20">

      **Chain Arts: Maelstrom** (พายุโซ่หมุนดูดมอนสเตอร์)
  *   `[3]`

      <img src="../../.gitbook/assets/400041033.png" alt="Apocalypse Cannon" height="20" width="20">

      **Apocalypse Cannon** (เรียกปืนใหญ่ยักษ์ยิงระเบิด)
  *   `[4]`

      <img src="../../.gitbook/assets/64121052.png" alt="Chain Arts: Crush" height="20" width="20">
...
* **🎯 แนะนำตั้งปุ่มบอท 1-4:**
  *   `[1]`
      ...
      <img src="../../.gitbook/assets/164001000.png" alt="As-You-Will Fan" height="20" width="20">

      **As-You-Will Fan** /

      <img src="../../.gitbook/assets/15111022.png" alt="Iron Fan Gale" height="20" width="20">

      **Iron Fan Gale** (พัดพายุเซียนกวาดมอน)
  *   `[2]`

      <img src="../../.gitbook/assets/164111003.png" alt="Earth: Stone Tremor" height="20" width="20">

      **Earth: Stone Tremor** (เสาหินทุบพื้นระเบิด)
  *   `[3]`

      <img src="../../.gitbook/assets/400041048.png" alt="Sage: Clone Rampage" height="20" width="20">

      **Sage: Clone Rampage** (แยกร่างร่างโคลนช่วยตีทั้งแมพ)
  *   `[4]`

      <img src="../../.gitbook/assets/164121008.png" alt="Scroll: Star Vortex" height="20" width="20">
