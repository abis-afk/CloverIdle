...
> 2.  คลิกที่ปุ่ม **ค้อนตีบวกสีแดง**&#x20;
>
>     <img src="../.gitbook/assets/BtEnchant3.png" alt="Enchant Button" height="20" width="20">
>
>     &#x20;ที่มุมขวาล่างของหน้าต่าง Inventory
...
![ขั้นตอนที่ 1 - การใช้ Spell Trace](../.gitbook/assets/upgrade_guide_step1_scroll.png)
...
| ประเภท Scroll | โอกาสสำเร็จ | สเตตัสที่ได้รับต่อช่อง (อาวุธ Lv.120+) | สเตตัสที่ได้รับต่อช่อง (ชุดเกราะ Lv.120+) | คำแนะนำการใช้งาน                                          |
| :-----------: | :---------: | -------------------------------------- | ----------------------------------------- | --------------------------------------------------------- |
|    **100%**   |   **100%**  | **+3 ATT / M.ATT**, +1 Main Stat       | **+3 Main Stat**, +HP                     | เหมาะสำหรับอุปกรณ์เริ่มต้น หรือตัวละคร Union ฟาร์มเลเวล   |
|    **70%**    |   **70%**   | **+5 ATT / M.ATT**, +2 Main Stat       | **+4 Main Stat**, +HP                     | คุ้มค่าและประหยัดที่สุดสำหรับผู้เล่นใหม่                  |
|    **30%**    |   **30%**   | **+7 ATT / M.ATT**, +3 Main Stat       | **+7 Main Stat**, +DEF/HP                 | **มาตรฐานสำหรับชุดเกราะ End-Game** (CRA, Absolab, Arcane) |
|    **15%**    |   **15%**   | **+9 ATT / M.ATT**, +4 Main Stat       | _(ชุดเกราะไม่มี Scroll 15%)_              | **มาตรฐานสำหรับอาวุธ End-Game** พลังโจมตีสูงสุด           |
...
![ขั้นตอนที่ 2 - การตีบวก Star Force](../.gitbook/assets/upgrade_guide_step2_starforce.png)
...
![ขั้นตอนที่ 3 - ระบบ Potential และ Cubes](../.gitbook/assets/upgrade_guide_step3_cubes.png)
...
| **Red Cube**                |   <img src="../.gitbook/assets/red_cube.png" alt="Red Cube" data-size="original">   |       Legendary       |        **Legendary**        | โอกาสเลื่อนขั้นสูง เหมาะสำหรับรีโรลหาออพชั่น 2-3 บรรทัด                                            |
| **Black Cube**              | <img src="../.gitbook/assets/black_cube.png" alt="Black Cube" data-size="original"> |       Legendary       |        **Legendary**        | **โอกาสเลื่อนขั้นสูงที่สุด** และสามารถเลือกเก็บออพชั่นเดิม (Before) หรือรับออพชั่นใหม่ (After) ได้ |
...
| ----------------------------- | :------------------: | :---------------------: | ----------------------- | ------------------------------------------ |
| **Boss Monster Damage %**     |       **+40%**       |     **+35% / +30%**     | อาวุธ, อาวุธรอง         | _(Emblem ไม่สามารถออก Boss Dmg ได้)_       |
...
| ------------------- | -------------------------------------- | :------------------: | :---------------------: | --------------------------------------------------------- |
| **ถุงมือ (Gloves)** | **Critical Damage %**                  |        **+8%**       |    _(มีเฉพาะ Prime)_    | **สำคัญที่สุดของถุงมือ!** (1 บรรทัดเทียบเท่า Stat 20-30%) |
...
| ---------------------------------- | :------------------: | :---------------------: | ------------------------------------------------------------- |
| **Item Drop Rate (อัตราดรอปของ)**  |       **+20%**       |    _(มีเฉพาะ Prime)_    | **ชุดฟาร์มของ/ล่าบอส** (สะสมจากออพชั่นอุปกรณ์ได้สูงสุด +100%) |
| **Meso Obtained (เงิน Meso ดรอป)** |       **+20%**       |    _(มีเฉพาะ Prime)_    | **ชุดฟาร์มเงินบอท** (สะสมจากออพชั่นอุปกรณ์ได้สูงสุด +100%)    |
...
| **ถุงมือ (Gloves)**                  | **Critical Damage %**         |                **+3%**               |      _(Prime only)_     |
| **หมวก (Hat)**                       | **Skill Cooldown Reduction**  |             **-1 วินาที**            |      _(Prime only)_     |
| **เกราะ & ประดับ (Armor/Accessory)** | **Main Stat %**               |                **+7%**               |         **+5%**         |
|                                      | **All Stat %**                |                **+5%**               |         **+4%**         |
|                                      | **Main Stat ตามเลเวลตัวละคร** | **+2 ต่อ 10 เลเวล** _(Lv.250 = +50)_ |   **+1 ต่อ 10 เลเวล**   |
|                                      | **Flat ATT / Magic ATT**      |                **+14**               |         **+11**         |

***

## 🔥 ขั้นตอนที่ 4: ระบบ Rebirth Flames (ออพชั่นไฟโบนัสสีเขียว)

![ขั้นตอนที่ 4 - Rebirth Flames และ Transfer Hammer](../.gitbook/assets/upgrade_guide_step4_flame_transfer.png)

Rebirth Flames ใช้สำหรับสุ่มค่า **Bonus Stats (ตัวเลขสีเขียว `(+ตัวเลข)` หลังค่าพลังพื้นฐาน)** ให้กับอุปกรณ์
...
### 4.2 ตารางออพชั่นทั้งหมดที่ Rebirth Flame สามารถสุ่มได้ (Flame Option Pool)

| สเตตัส (Flame Stat Line)                  | ชิ้นส่วนที่ออกได้                  |     ช่วงค่าสเตตัส (Tier 1 ➔ Tier 7)     | คำอธิบายและจุดเด่น                         |
| ----------------------------------------- | ---------------------------------- | :-------------------------------------: | ------------------------------------------ |
| **Flat Weapon / Magic ATT**               | **อาวุธ (Weapon)**                 |    **+15 ถึง +150+** _(ตาม Base ATT)_   | **สำคัญที่สุดของอาวุธ!** ดันดาเมจได้มหาศาล |
| **Flat Weapon / Magic ATT**               | เกราะ & เครื่องประดับ              |              **+1 ถึง +7**              | สเตตัสโบนัสเล็กน้อยบนชุดเกราะ              |
| **Boss Monster Damage %**                 | **อาวุธเท่านั้น!**                 |      **+4% ถึง +14%** _(Tier 3-7)_      | ช่วยเร่งดาเมจเมื่อต่อสู้กับบอส             |
| **Damage %**                              | **อาวุธเท่านั้น!**                 |       **+1% ถึง +7%** _(Tier 1-7)_      | เพิ่มพลังโจมตีทั่วไป                       |
| **All Stat %**                            | **ทุกชิ้นส่วน** (เน้นเกราะ/ประดับ) |       **+1% ถึง +7%** _(Tier 1-7)_      | **ออพชั่น % หนึ่งเดียวของไฟบนชุดเกราะ!**   |
| **Single Stat (STR, DEX, INT, LUK)**      | **ทุกชิ้นส่วน**                    |    **+10 ถึง +75+** _(ตามเลเวลไอเทม)_   | สเตตัสเดี่ยวบวกตรง                         |
| **Dual Stat (สเตตัสคู่ 2 ค่าในแถวเดียว)** | **ทุกชิ้นส่วน**                    |          **+5 ถึง +40+ ต่อค่า**         | STR+DEX, STR+INT, STR+LUK, DEX+LUK ฯลฯ     |
| **Max HP / Max MP**                       | เกราะ & เครื่องประดับ              |           **+300 ถึง +3,500+**          | เลือดและมานาบวกตรง                         |
| **Equip Level Requirement Reduction**     | ทุกชิ้นส่วน                        |           **-5 ถึง -20 เลเวล**          | ลดเลเวลสวมใส่ ช่วยให้ใส่ของได้เร็วขึ้น     |
| **Defense, Speed, Jump**                  | ทุกชิ้นส่วน                        | DEF +10 ถึง +70 / Speed, Jump +1 ถึง +7 | สเตตัสรองเบ็ดเตล็ด                         |

> ⚠️ **สิ่งที่ Rebirth Flame "ไม่มีวันสุ่มได้" (อย่าจำสับสน):**
>
> * ❌ **ไม่มี Main Stat % เดี่ยว** (เช่น STR% หรือ INT% ไม่มีในไฟ มีเฉพาะ All Stat % เท่านั้น)
> * ❌ **ไม่มี Critical Damage %**
> * ❌ **ไม่มี Critical Rate %**
> * ❌ **ไม่มี Ignore Enemy DEF (IED) %**
> * ❌ **ไม่มี Item Drop Rate % หรือ Meso Obtained %**
> * ❌ **ไม่มี ลดคูลดาวน์สกิล (Cooldown Reduction)**

***

### 4.3 สูตรคำนวณ Flame Score และเป้าหมายของไฟระดับจบ (End-Game Flame)

สำหรับชุดเกราะและเครื่องประดับ ผู้เล่นนิยมคิดคะแนนความคุ้มค่าเป็น **Flame Score**: $$\text{Flame Score} = \text{Main Stat รวม (เดี่ยว + คู่)} + (\text{All Stat \%} \times 10) + (\text{Flat ATT} \times 4)$$

* **ตัวอย่างไฟระดับเทพ (God Tier):**
  * หมวก หรือ เสื้อ Absolab/Arcane ได้: `STR +56` + `STR/DEX +32` + `All Stat 6%`
  * คิดเป็น Main Stat รวมสูงถึง **88 Flat STR + 6% All Stat** (คะแนนเทียบเท่า **148+ Stat**)

***

## 📊 ตารางเปรียบเทียบแยก 3 ระบบให้ชัดเจน (Cube vs Bonus Cube vs Rebirth Flame)

เพื่อให้เห็นภาพชัดเจนว่าแต่ละระบบทำหน้าที่อะไร และควรหาออพชั่นไหนจากระบบใด:

| สเตตัสที่ต้องการ                         |      🔮 Cube ปกติ (แถวบน)      |     🌟 Bonus Cube (แถวล่าง)    |    🔥 Rebirth Flame (ไฟเขียว)   |
| ---------------------------------------- | :----------------------------: | :----------------------------: | :-----------------------------: |
| **Main Stat % (STR%, DEX%, INT%, LUK%)** |  ✅ **มี (สูงสุด 12% ต่อแถว)**  |   ✅ **มี (สูงสุด 7% ต่อแถว)**  |  ❌ **ไม่มี (มีแค่ All Stat %)** |
| **All Stat %**                           |      ✅ **มี (สูงสุด 9%)**      |      ✅ **มี (สูงสุด 5%)**      |       ✅ **มี (สูงสุด 7%)**      |
| **Flat ATT / Magic ATT (บวกตรง)**        |     ❌ ไม่มี (มีเฉพาะ ATT%)     |  ✅ **มี (+14 บนเกราะ/ประดับ)** |  ✅ **มี (บนอาวุธบวกหลักร้อย)**  |
| **Boss Damage %**                        |  ✅ **มี (สูงสุด 40% บนอาวุธ)** |  ✅ **มี (สูงสุด 18% บนอาวุธ)** |  ✅ **มี (สูงสุด 14% บนอาวุธ)**  |
| **ATT % / Magic ATT %**                  |  ✅ **มี (สูงสุด 12% บน WSE)**  |   ✅ **มี (สูงสุด 8% บน WSE)**  |           ❌ **ไม่มี**           |
| **Ignore Enemy DEF (IED) %**             |  ✅ **มี (สูงสุด 40% บน WSE)**  | ✅ **มี (สูงสุด 8% บน Emblem)** |           ❌ **ไม่มี**           |
| **Critical Damage %**                    |     ✅ **มี (+8% บนถุงมือ)**    |     ✅ **มี (+3% บนถุงมือ)**    |           ❌ **ไม่มี**           |
| **ลดคูลดาวน์สกิล (Cooldown -s)**         | ✅ **มี (-1 ถึง -2 วิ บนหมวก)** |     ✅ **มี (-1 วิ บนหมวก)**    |           ❌ **ไม่มี**           |
| **Item Drop Rate / Meso Rate %**         |    ✅ **มี (+20% บนประดับ)**    |             ❌ ไม่มี            |           ❌ **ไม่มี**           |
| **สเตตัสคู่ (Dual Stats)**               |             ❌ ไม่มี            |             ❌ ไม่มี            |      ✅ **มี (STR+DEX ฯลฯ)**     |
| **ลดเลเวลสวมใส่ (Level Reduction)**      |             ❌ ไม่มี            |             ❌ ไม่มี            |   ✅ **มี (-5 ถึง -20 เลเวล)**   |
| **ค่าใช้จ่ายในการสุ่ม**                  |  ใช้ลูกเต๋า Red/Black/Meister  |    ใช้ Bonus Potential Cube    | ใช้ Rebirth Flame (แดง/รุ้ง/ดำ) |
